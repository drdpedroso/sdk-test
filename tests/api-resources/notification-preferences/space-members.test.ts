...
describe('resource spaceMembers', () => {
  test('retrieve', async () => {
    const responsePromise = headlessClientSDK.notificationPreferences.spaceMembers.retrieve(0);
  ...
  test('retrieve: request options instead of params are passed correctly', async () => {
    ...
    await expect(
      headlessClientSDK.notificationPreferences.spaceMembers.retrieve(0, {
