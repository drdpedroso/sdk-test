...
describe('resource spaceMembers', () => {
  test('retrieve', async () => {
    const responsePromise = client.notificationPreferences.spaceMembers.retrieve(0);
  ...
  test('retrieve: request options instead of params are passed correctly', async () => {
    ...
    await expect(client.notificationPreferences.spaceMembers.retrieve(0, { path: '/_stainless_unknown_path' }))
      .rejects
