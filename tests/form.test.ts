import { multipartFormRequestOptions, createForm } from 'headless-client-sdk/core';
import { Blob } from 'headless-client-sdk/_shims/index';
import { toFile } from 'headless-client-sdk';
