...
export class UserLikes extends APIResource {
   ...
   */
  list(commentId: number | string, query?: UserLikeListParams, options?: Core.RequestOptions): Core.APIPromise<Shared.UserLikes>
  list(commentId: number | string, options?: Core.RequestOptions): Core.APIPromise<Shared.UserLikes>
  list(commentId: number | string, query: UserLikeListParams | Core.RequestOptions = {}, options?: Core.RequestOptions): Core.APIPromise<Shared.UserLikes> {
